...
- **What I tried:** 
1.  I went to my user's properties and checked `Unlock account` 
   
   ![is1_2.png](Images/is1_2.png)
1. I went back onto the built-in administrator account and searched for my username in Active Directory Users and Computers to see if this was indeed disabled. After finding my account, I went to my user's properties and enabled the account. 2.![is1_3.png](Images/is1_3.png)
