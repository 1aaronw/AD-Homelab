...
![[Pasted image 20260707181950.png]]
...
![[Pasted image 20260707183034.png]]
...
![[Pasted image 20260707183820.png|697]]
...
![[Pasted image 20260707191323.png]]

We still need to give access to my user in `ADMINS` to be a Domain Admin, so I add that in my user's "Member of" properties
![[Pasted image 20260707191430.png]]

Now, we can sign out and log back in as our new admin account!
![[Pasted image 20260707191502.png]]

### Issue #1: [Admin account disabled]

- **Symptom:** I initially couldn't successfully log onto my admin account as it notified that my account was disabled.![[Screenshot 2026-07-01 212203.png]]
- **What I tried:** 
1.  I went to my user's properties and checked `Unlock account`![[Screenshot 2026-07-01 212436.png]]
2. I went back onto the built-in administrator account and searched for my username in Active Directory Users and Computers to see if this was indeed disabled. After finding my account, I went to my user's properties and enabled the account. 2.![[Screenshot 2026-07-01 213641 1.png]]
...
![[Pasted image 20260707192707.png]]
![[Pasted image 20260707192712.png]]

After installed, we move onto Routing and Remote Access via the tools section
![[Pasted image 20260707193439.png]]

In here, we can configure the DC to use NAT
![[Pasted image 20260707193535.png]]
...
![[Pasted image 20260707193741.png]]
...
![[Pasted image 20260707194915.png]]
...
![[Pasted image 20260707200116.png]]
...
![[Pasted image 20260707200134.png]]
Run it, adding the Windows 11 ISO and installing Windows 11 Pro
![[Pasted image 20260707200205.png]]
...
![[Pasted image 20260707200234.png]]

Name the PC user and proceed with the setup while disabling optional features

Upon logging into the client account, we can ping `mydomain.com` and see that all packets were sent, indicating a successful response
![[Pasted image 20260707201917.png]]
...
![[Pasted image 20260707202055.png]]

In our DHCP on our DC virtual machine, we now se an address lease for the CLIENT1 PC
![[Pasted image 20260707202144.png]]

It also shows up as a computer in our Active Directory Users and Computers
...
![[Pasted image 20260707202313.png]]
![[Pasted image 20260707202325.png]]


### Issue #2: [Clients can't connect to internet]

- **Symptom:** Testing my ping to the internet seems to time out, indicating something wrong with my DNS server![[Pasted image 20260707200708.png]]
- **What I tried:** 
